...
$username = $email = $password = $confirm_password = $status = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["email"]))){
        ...
        $email_err = "email must have Unique.";
    } else{
    ...
    if(empty($username_err) && empty($email_err) && empty($password_err) && empty($confirm_password_err) && !empty($status)){
    ...
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div class="form-group">
             ...
             <div class="form-group">
                <label>Email</label>
                <input type="email" name="email" class="form-control <?php echo (!empty($email_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $email_err; ?>">
